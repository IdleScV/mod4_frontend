...
function Lobby({ roomNumber, firebase, roomNumberSet }) {
	...
	const [ JSONdata, JSONdataSet ] = useState(null);
	...
	//Every time ticker changes it will call fetch user...
	...
	return (
		<div>
			{gameProgress ? gameProgress === 'open' ? (
				...
				<GameScreen gameProgress={gameProgress} gameProgressSet={gameProgressSet} JSONdata={JSONdata} />
			) : (
